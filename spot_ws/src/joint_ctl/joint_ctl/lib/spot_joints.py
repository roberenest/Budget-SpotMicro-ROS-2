...
(frc_min, frc_max) = get_joint_limits(295, spot_joint_limits["coxa_min"], spot_joint_limits["coxa_max"])
(frh_min, frh_max) = get_joint_limits(245, spot_joint_limits["hip_min"],  spot_joint_limits["hip_max"], True)
(frk_min, frk_max) = get_joint_limits(360, spot_joint_limits["knee_min"], spot_joint_limits["knee_max"])
(blc_min, blc_max) = get_joint_limits(323, spot_joint_limits["coxa_min"], spot_joint_limits["coxa_max"])
(blh_min, blh_max) = get_joint_limits(430, spot_joint_limits["hip_min"],  spot_joint_limits["hip_max"], True)
...
(brh_min, brh_max) = get_joint_limits(280, spot_joint_limits["hip_min"],  spot_joint_limits["hip_max"], True)
(brk_min, brk_max) = get_joint_limits(309, spot_joint_limits["knee_min"], spot_joint_limits["knee_max"])
